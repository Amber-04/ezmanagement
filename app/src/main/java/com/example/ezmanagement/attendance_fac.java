...
public class attendance_fac extends AppCompatActivity implements AdapterView.OnItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        atn_btn.setOnClickListener(view -> {
            if (ContextCompat.checkSelfPermission(attendance_fac.this, Manifest.permission.READ_EXTERNAL_STORAGE) == PackageManager.PERMISSION_GRANTED) {
                selectPDF();
                if (pdfUri != null) {
                    uploadFile(pdfUri);
                }
            } else {
                ActivityCompat.requestPermissions(attendance_fac.this, new String[]{Manifest.permission.READ_EXTERNAL_STORAGE}, 9);
            }
        });
    }
                        ...
                        reference.child(filename).setValue(url).addOnCompleteListener(new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                if(task.isSuccessful())
                                    Toast.makeText(attendance_fac.this, "File Successfully uploaded", Toast.LENGTH_SHORT).show();
                                else
                                    Toast.makeText(attendance_fac.this, "File not Successfully uploaded", Toast.LENGTH_SHORT).show();
                            }
                        });
                    }
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if(requestCode==9 && grantResults[0] == PackageManager.PERMISSION_GRANTED)
        {
            ...
            Toast.makeText(attendance_fac.this, "please provide permission",Toast.LENGTH_SHORT).show();
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if(requestCode==86 && resultCode==RESULT_OK && data!=null)
        {
            ...
            Toast.makeText(attendance_fac.this, "Please select a file", Toast.LENGTH_SHORT).show();
        }
